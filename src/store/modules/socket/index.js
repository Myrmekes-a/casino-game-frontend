...
// Use HTTPS for socket when page is HTTPS (avoids mixed content / ws vs wss)
...
const state = {
    ...
    socketGeneral: socketIo(getSocketBaseUrl()+'/general', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketCrash: socketIo(getSocketBaseUrl()+'/crash', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketRoll: socketIo(getSocketBaseUrl()+'/roll', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketBlackjack: socketIo(getSocketBaseUrl()+'/blackjack', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketDuels: socketIo(getSocketBaseUrl()+'/duels', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketMines: socketIo(getSocketBaseUrl()+'/mines', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketTowers: socketIo(getSocketBaseUrl()+'/towers', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketUnbox: socketIo(getSocketBaseUrl()+'/unbox', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketBattles: socketIo(getSocketBaseUrl()+'/battles', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketUpgrader: socketIo(getSocketBaseUrl()+'/upgrader', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketCashier: socketIo(getSocketBaseUrl()+'/cashier', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']}),
    socketAdmin: socketIo(getSocketBaseUrl()+'/admin', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['websocket']})
}
