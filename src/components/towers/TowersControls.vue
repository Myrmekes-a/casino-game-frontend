...
<style scoped>
    ...
    .towers-controls .controls-mode button .button-inner {
        ...
        color: #5e768e;
        background-color: #07253b;
        clip-path: polygon(6px 0, calc(100% - 6px) 0, 100% 25%, 100% 75%, calc(100% - 6px) 100%, 7px 100%, 0 75%, 0 25%);
    }
    ...
    .towers-controls button.button-bet:hover {
        transition-duration: .2s; 
        opacity: .8;
    }
    .towers-controls button.button-bet:active {
        transition-duration: .2s;
        scale: .9;
    }
    ...
    .towers-controls button.button-cashout::after {
        ...
        left: 1px;
        background-color: #07253b;
        clip-path: polygon(6px 0, calc(100% - 6px) 0, 100% 25%, 100% 75%, calc(100% - 6px) 100%, 5px 100%, 0 75%, 0 25%);
        z-index: -1;
    }
