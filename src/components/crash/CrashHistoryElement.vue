...
<style scoped>
    ...
    button.crash-history-element::before {
        ...
        clip-path: polygon(4px 0, calc(100% - 5px) 0, 100% 25%, 100% 75%, calc(100% - 5px) 100%, 4px 100%, 0 75%, 0 25%);
    }
    ...
    button.crash-history-element.element-mid::after {
        ...
        clip-path: polygon(5px 0, calc(100% - 4px) 0, 100% 25%, 100% 75%, calc(100% - 5px) 100%, 4px 100%, 0 75%, 0 25%);
    }
