...
<style scoped>
    ...
    .upgrader-game .amount-input input {
        ...
        clip-path: polygon(10px 0, calc(100% - 9px) 0, 100% 25%, 100% 75%, calc(100% - 11px) 100%, 9px 100%, 0 75%, 0 25%);
    }
    ...
    .upgrader-game .input-buttons button .button-inner {
        ...
        clip-path: polygon(5px 0, calc(100% - 4px) 0, 100% 25%, 100% 75%, calc(100% - 4px) 100%, 5px 100%, 0 75%, 0 25%);
    }
