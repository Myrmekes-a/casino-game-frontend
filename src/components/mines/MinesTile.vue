...
<style scoped>
    ...
    .mines-tile .tile-coin {
        border-radius: 10px;
        border-bottom: 5px solid #A67B30;
        background: #E59914;
        /* after:block after:pt-[100%] hover:duration-200 hover:bg-[#383233] hover:translate-y-[-4px] */
    }
    .button-reveal::after {
        display: block;
        padding-top: 100%;
    ...
    .mines-tile .tile-mine {
        border-radius: 10px;
        border-bottom: 5px solid #460E1D;
        background: #3F1B1A;
    ...
    .mines-tile .coin-box {
        ...
        padding: 1px;
        /* border-radius: 7px;
        box-shadow: 0px 2px 4px rgba(7, 26, 41, 0.25); */
        z-index: 1;
    }
