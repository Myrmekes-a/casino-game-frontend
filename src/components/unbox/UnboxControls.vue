...
<style scoped>
    ...
    .unbox-controls .controls-count button::before {
        ...
        left: 0;
        background: #07253b;
        clip-path: polygon(9px 0, calc(100% - 8px) 0, 100% 25%, 100% 75%, calc(100% - 8px) 100%, 8px 100%, 0 75%, 0 25%);
        z-index: -1;
    }
    ...
    .unbox-controls .controls-bet button.button-bet:hover {
        transition-duration: .2s;
        opacity: .8;
    }
    .unbox-controls .controls-bet button.button-bet:active {
        transition-duration: .2s;
        scale: .9;
    }
