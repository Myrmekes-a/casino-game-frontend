<template>
    <button v-on:click="unboxSetFilterSort(unboxFilterSort === 'highest' ? 'lowest' : 'highest')" class="unbox-filter-sort" v-bind:class="{ 'sort-lowest': unboxFilterSort === 'Lowest' }">
...
<style scoped>
    ...
    button.unbox-filter-sort .button-inner:hover {
