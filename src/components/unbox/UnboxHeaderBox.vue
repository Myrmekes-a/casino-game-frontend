...
<style scoped>
    ...
    .unbox-header-box a.link-back:active {
    ...
    .unbox-header-box a.link-back .link-inner {
        ...
        clip-path: polygon(9px 0, calc(100% - 9px) 0, 100% 25%, 100% 75%, calc(100% - 8px) 100%, 9px 100%, 0 75%, 0 25%);
    }
    ...
    .unbox-header-box .info-inner {
        ...
        color: #ffffff;
        background: #051b2d;
        clip-path: polygon(9px 0, calc(100% - 10px) 0, 100% 25%, 100% 75%, calc(100% - 10px) 100%, 10px 100%, 0 75%, 0 25%);
    }
    ...
    .unbox-header-box .image-inner {
        ...
        align-items: center;
        background: #051b2d;
        clip-path: polygon(10px 0, calc(100% - 11px) 0, 100% 25%, 100% 75%, calc(100% - 10px) 100%, 10px 100%, 0 75%, 0 25%);
    }
    ...
    .unbox-header-box button.button-fair:active {
        transition-duration: .2s;
        scale: .9;
    }
