        ...
        <div class="code-inner">
            <div class="inner-info">
                <div class="info-text">
                    ...
                    <div class="text-link">
                        https://demo.grakairos.com/?a={{ affiliatesData.data !== null && affiliatesData.data.code !== undefined ? affiliatesData.data.code : '' }}
    ...
    export default {
       ...
       methods: {
            ...
            affiliatesCopyButton() {
                ...
                el.value = ' https://demo.grakairos.com/?a=' + (this.affiliatesData.data !== null && this.affiliatesData.data.code !== undefined ? this.affiliatesData.data.code : '');
...
<style scoped>
    ...
    .affiliates-code .inner-input::before {
        ...
        clip-path: polygon(11px 0, calc(100% - 10px) 0, 100% 25%, 100% 75%, calc(100% - 11px) 100%, 12px 100%, 0 75%, 0 25%);
    }
