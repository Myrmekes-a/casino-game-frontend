...
<style scoped>
    ...
    .admin-user-games .games-pagination button:disabled {
        cursor: not-allowed;
    }

    .admin-user-games .games-pagination button:before {
        content: '';
        width: 100%;
        height: 100%;
        position: absolute;
        ...
        clip-path: polygon(6px 0, calc(100% - 4px) 0, 100% 25%, 100% 75%, calc(100% - 5px) 100%, 5px 100%, 0 75%, 0 25%);
        z-index: -1;
    }

    .admin-user-games .games-pagination button:disabled:before {
        background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, #05253e 100%);
    }

    .admin-user-games .games-pagination button:after {
        content: '';
        width: calc(100% - 2px);
        height: calc(100% - 2px);
        position: absolute;
        ...
        left: 1px;
        background: #07253c;
        clip-path: polygon(5px 0, calc(100% - 5px) 0, 100% 25%, 100% 75%, calc(100% - 6px) 100%, 5px 100%, 0 75%, 0 25%);
        z-index: -1;
    }
