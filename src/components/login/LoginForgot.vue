...
<style scoped>
    ...
    .login-forgot button.button-forgot:hover {
        transition-duration: .2s; 
        opacity: .8;
    }
    .login-forgot button.button-forgot:active {
        transition-duration: .2s;
        scale: .9;
    }
    ...
    .login-forgot button.button-reset:hover {
        transition-duration: .2s; 
        opacity: .8;
    }
    .login-forgot button.button-reset:active {
        transition-duration: .2s;
        scale: .9;
    }
