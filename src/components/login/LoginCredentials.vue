<template>
    ...
    <div class="login-credentials">
        ...
        <div class="credentials-info">
            By accessing demo.grakairos.com, I attest that I am at least 18 years old and have read and agree with the <button v-on:click="loginTermsButton()" class="button-terms">Terms of Service</button>.
        </div>
...
<style scoped>
    ...
    .login-credentials .element-input::before {
        ...
        clip-path: polygon(16px 0, calc(100% - 16px) 0, 100% 25%, 100% 75%, calc(100% - 16px) 100%, 15px 100%, 0 75%, 0 25%);
    }
    ...
    .login-credentials button.button-toggle::before {
        ...
        clip-path: polygon(11px 0, calc(100% - 11px) 0, 100% 25%, 100% 75%, calc(100% - 10px) 100%, 11px 100%, 0 75%, 0 25%);
        z-index: -1;
    }
