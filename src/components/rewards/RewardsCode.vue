<template>
    <div class="rewards-code">
        <div class="code-inner">
            ...
            <div class="inner-title">EARN FREE REWARDS</div>
            <div class="inner-info">Start your journey on SlotGemz with a little bonus! Redeem a code to earn a free 10 Robux.</div>
