<template>
    <div class="modal-terms">
        <div class="terms-header">
            ...
            <p>Welcome to SlotGemz! By using our website and services, you agree to be bound by the following terms and conditions (the "Terms of Service"). Please read them carefully.</p>
        </div>
        <div class="terms-list">
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>1.1 These Terms of Service constitute a legally binding agreement between you and SlotGemz
                    (the "Owner and Operator" of SlotGemz). By successfully registering an account on our website
                    and providing your Growtopia credentials or authentication, you agree to be bound by these terms
                    and conditions.</p>
                    ...
                    <p>1.3 SlotGemz is a virtual gaming website that offers fun and immersive games based on the virtual 
                    currency known as Robux. SlotGemz provides free-to-play opportunities on the site. To participate for 
                    free, you must register an account on SlotGemz. By doing so, you can join our rain feature, which 
                    ...
                    not allowed to transfer, attempt to transfer, or offer to transfer Robux won off SlotGemz for cash, 
                    cash equivalent, or any thing of value on a third-party platform.</p>
                    <p>b) SlotGemz will give you Robux FREE OF CHARGE on:
                        <ul>
                            <li>Rain Distribution - Rains occur on the site which spread Robux to all users who participate 
                            in them. To claim rains, you simply need to register an account on SlotGemz and complete KYC to 
                            collect them.</li>
                            <li>Promotional Giveaways - Promotional giveaways organized by SlotGemz on its social media accounts 
                            (Discord, Twitter, YouTube, Twitch, etc.).</li>
                        </ul>
                    </p>
                    <p>c) You may also win more Robux when you play games on SlotGemz, and you may purchase more Robux on SlotGemz 
                    to play.</p>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>2.1 In order to use our website and services, you must register an account by providing your
                        Growtopia credentials or authentication. You are solely responsible for maintaining the security of
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>4.1. SlotGemz is a free-to-play website. You can obtain free SlotGemz coins from various sources, 
                    including rain, promo codes, rewards, daily cases and giveaways. SlotGemz coins have no monetary value, 
                    and their purpose is solely for entertainment.</p>
                    <p>4.2. You can exchange your limiteds or Robux for SlotGemz coins or purchase SlotGemz coins directly 
                    ...
                    or purchase SlotGemz coins.</p>
                    <p>4.4. To ensure security and compliance, SlotGemz reserves the right to perform identity verification (KYC) 
                    when using cryptocurrencies, cards, or other payment methods to acquire SlotGemz coins. Failure to provide 
                    requested documents may result in account termination.</p>
                    <p>4.5. SlotGemz retains the right to adjust the coin rate.</p>
                    <p>4.6. We provide data on digital assets used for purchasing SlotGemz coins, but we make no representations 
                    regarding their value, quality, suitability, or accuracy. These assets are used for entertainment purposes.</p>
                    <p>4.7. SlotGemz coins are given out for free. Games like crash, mines, towers, and roll can be played with 0 
                    coins.</p>
                    <p>4.8. Users who acquire coins for free have the same winning odds as users who purchase SlotGemz coins.</p>
                </div>
            </div>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>5.1. SlotGemz strictly prohibits real-world trading. Sweepstakes prizes are non-transferable.</p>
                    <p>5.2. SlotGemz coins and limiteds hold no monetary value, are not private property, and cannot be sold, 
                    transferred, returned, or exchanged for real-world money or items of value.</p>
                    <p>5.3. You agree not to sell, transfer, or aid others in the exchange of SlotGemz coins or limiteds. Any 
                    attempt at real-world trading will result in account termination.</p>
                    <p>5.4. SlotGemz coins do not grant ownership rights, titles, or monetary value; they do not constitute real 
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>6.1. You can swap your SlotGemz tokens for limiteds or Robux using our marketplace feature.</p>
                    <p>6.2. Due to factors beyond SlotGemz's control, some withdrawals may experience delays. While most withdrawals 
                    ...
                    <p>6.3. After a user purchases SlotGemz tokens, they must wager an amount equal to their purchase before they can 
                    withdraw.</p>
                </div>
            </div>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>7.1 You can register and use only one account on SlotGemz.</p>
                    ...
                    to obtain access to SlotGemz, such as using a VPN service or other masking 
                    effort.</p>
                </div>
            </div>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>8.1 SlotGemz offers a rewards program called "rain". A base of 250 coins 
                    ...
                    join and receive a share of the rain's total pot. Rain is a reward for SlotGemz 
                    ...
                    termination of your account at SlotGemz's sole discretion.</p>
                    <p>8.2 SlotGemz also deploys another rewards program called "daily cases''. Daily 
                    cases are allowed to be opened by users once per day depending on their correlated 
                    level on SlotGemz. SlotGemz provides a daily case that is unlocked once per day to 
                    ...
                    the case once per day with the same odds as anyone else who uses the website. SlotGemz 
                    has the right to adjust the case contents and percentages of every daily case at its 
                    discretion.</p>
                    <p>8.3 Please note that the Rain feature listed on SlotGemz has guidelines set in place to 
                    prevent users from abusing it. We are unable to list every method a user is able to abuse the 
                    rain. If a user is caught abusing the rain while using SlotGemz as a free-to-play method, their 
                    access to our service will be immediately terminated.
                        <ul>
                            ...
                            to account termination across every account ever used on SlotGemz.</li>
                            ...
                            every account ever used on SlotGemz.</li>
                            ...
                            across every account ever used on SlotGemz.</li>
                            <li>Users depositing the minimum amount to claim rains every 2 week period without using the site as a 
                            free-to-play feature are subject to account termination across every account ever used on SlotGemz.</li>
                        </ul>
                    </p>
                    <p></p>
                    <p></p>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>9.1 SlotGemz does not issue refunds on digital products once the order is confirmed and the product is sent. If 
                    you have any issues with receiving or downloading the product, please contact us at support@SlotGemz.com and we will 
                    assist you.</p>
                    <p>9.2 Refunds may be given at our discretion for technical issues determined by SlotGemz.</p>
                    ...
                    <p>9.4 If you make a purchase on SlotGemz that results in a chargeback, we may terminate your account. You agree that you 
                    must contact SlotGemz to seek a resolution of any issue before initiating a chargeback. We reserve the right to withhold any 
                    Robux generated from transactions that result in a chargeback.</p>
                    <p>9.5 You are responsible for any credit card chargebacks, dishonored checks, and any related fees that SlotGemz incurs with 
                    respect to your account, along with any additional fees or penalties imposed by our third-party billing agent.</p>
                    <p>9.6 SlotGemz utilizes third-party payment processors and gateways, and we reserve the right to contract with additional 
                    third-party payment processors and gateways in our sole discretion to process any and all payments associated with SlotGemz. 
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    ...
                    to comply with the legal process or as otherwise permitted by the privacy policy of SlotGemz (the Owner and Operator of SlotGemz).</p>
                    <p>13.2 Our privacy policy is available at https://www.SlotGemz.com/privacy.</p>
                </div>
            </div>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    ...
                    <p>16.5 SlotGemz reserves the right to adjust your balance at its sole discretion. SlotGemz is in no way affiliated with the Ubisoft Entertainment or 
                    its trademarks.</p>
                </div>
            </div>
