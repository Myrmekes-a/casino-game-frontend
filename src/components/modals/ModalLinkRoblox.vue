...
<style scoped>
    ...
    .modal-link-roblox .element-input:before {
        ...
        clip-path: polygon(16px 0, calc(100% - 15px) 0, 100% 25%, 100% 75%, calc(100% - 16px) 100%, 16px 100%, 0 75%, 0 25%);
    }
    ...
    .modal-link-roblox .element-input input {
        ...
        clip-path: polygon(16px 0, calc(100% - 15px) 0, 100% 25%, 100% 75%, calc(100% - 17px) 100%, 16px 100%, 0 75%, 0 25%);
    }
    ...
    .modal-link-roblox button.button-toggle::before {
        ...
        clip-path: polygon(11px 0, calc(100% - 11px) 0, 100% 25%, 100% 75%, calc(100% - 11px) 100%, 12px 100%, 0 75%, 0 25%);
        z-index: -1;
    }
    ...
    .modal-link-roblox button.button-action .button-inner {
        ...
        font-size: 18px;
        font-weight: 800;
        clip-path: polygon(11px 0, calc(100% - 12px) 0, 100% 25%, 100% 75%, calc(100% - 12px) 100%, 11px 100%, 0 75%, 0 25%);
    }
