...
<style scoped>
    ...
    .modal-tip .tip-input::before {
        ...
        clip-path: polygon(14px 0, calc(100% - 14px) 0, 100% 25%, 100% 75%, calc(100% - 14px) 100%, 13px 100%, 0 75%, 0 25%);
    }
    ...
    .modal-tip .tip-input input {
        ...
        color: #ffffff;
        background-color: #072435;
        clip-path: polygon(13px 0, calc(100% - 14px) 0, 100% 25%, 100% 75%, calc(100% - 14px) 100%, 14px 100%, 0 75%, 0 25%);
    }
    ...
    .modal-tip .tip-input button.button-tip:hover {
        transition-duration: .2s; 
        opacity: .8;
    }
    .modal-tip .tip-input button.button-tip:active {
        transition-duration: .2s;
        scale: .9;
    }
    .modal-tip .tip-input button.button-tip .button-inner {
        ...
        clip-path: polygon(6px 0, calc(100% - 6px) 0, 100% 25%, 100% 75%, calc(100% - 4px) 100%, 6px 100%, 0 75%, 0 25%);
    }
