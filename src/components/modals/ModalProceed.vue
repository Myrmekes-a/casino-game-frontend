<template>
    <div class="modal-proceed">
        ...
        <div class="proceed-info">You will be directed to a third party provider that processes {{ modalsData.provider === 'skinify' ? 'steam item' : 'credit card' }} payments for slotgemz. All the information you enter on their site is protected and encrypted.</div>
...
<style scoped>
    ...
    .modal-proceed button.button-back .button-inner {
        ...
        clip-path: polygon(6px 0, calc(100% - 7px) 0, 100% 25%, 100% 75%, calc(100% - 6px) 100%, 5px 100%, 0 75%, 0 25%);
