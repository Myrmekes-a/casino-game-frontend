    ...
    <footer id="footer">
        <div class="footer-top">
            <div class="top-info">
                ...
                <div class="info-text">
                    demo.grakairos.com is the #1 Growtopia Gambling Website and offers the best experience & reward to our users.
            ...
            <div class="top-links">
                ...
                <div class="links-section">
                    ...
                    <a href="https://discord.gg/casino_slotgemz" target="_blank">Support</a>
                    <button v-on:click="modalsSetShow('Fair')">Provably Fair</button>
                </div>
                <div class="links-section">
                    <div class="section-title">SOCIALS</div>
                    <a href="https://twitter.com/casino_slotgemz" target="_blank">
                    ...
                    <a href="https://discord.com/invite/casino_slotgemz" target="_blank">
                        <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.twitch.tv/casino_slotgemz" target="_blank">
        ...
        <div class="footer-bottom">
            <span class="gradient-green">slotgemz is not affiliated, associated or partnered with Ubisoft Entertainment in any way. We are not authorized, endorsed or sponsored by Ubisoft Entertainment. All Growtopia trademarks remain property of Ubisoft Entertainment.</span>
        </div>
    </footer>
</template>
