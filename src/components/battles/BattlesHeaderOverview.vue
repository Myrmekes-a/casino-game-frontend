...
<style scoped>
    ...
    .battles-header-overview .amount-container:before {
        ...
        left: 0;
        background: #0a2943;
        clip-path: polygon(8px 0, calc(100% - 9px) 0, 100% 25%, 100% 75%, calc(100% - 9px) 100%, 8px 100%, 0 75%, 0 25%);
    }
    ...
    .battles-header-overview a.link-create:hover {
        transition-duration: .2s; 
        opacity: .8;
    }
    .battles-header-overview a.link-create:active {
        transition-duration: .2s;
        scale: .9;
    }
