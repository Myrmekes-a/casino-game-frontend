...
<style scoped>
    ...
    .battles-game-element .separator-inner {
        ...
        clip-path: polygon(4px 0, calc(100% - 4px) 0, 100% 25%, 100% 75%, calc(100% - 4px) 100%, 5px 100%, 0 75%, 0 25%);
    }
    ...
    .battles-game-element .amount-inner {
        ...
        padding: 10px 17px;
        background: #0e233b;
        clip-path: polygon(8px 0, calc(100% - 8px) 0, 100% 10px, 100% calc(100% - 9px), calc(100% - 8px) 100%, 8px 100%, 0 calc(100% - 10px), 0 10px);
    }
