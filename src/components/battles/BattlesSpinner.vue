                ...
                handler(data, dataOld) {
                    if(this.battlesGameData.game.state === 'rolling') {
                        ...
                        for(const [index, bet] of this.battlesGameData.game.bets.entries()) {
                            this.battlesReelStyle = { transform: 'translateX(0px) translateY(-2416.6px)', transition: 'none' };
...
<style scoped>
    ...
    .battles-spinner::before {
        ...
        left: 0;
        background: #0b2840;
        clip-path: polygon(24px 0, calc(100% - 24px) 0, 100% 24px, 100% calc(50% - 8px), calc(100% - 8px) 50%, 100% calc(50% + 8px), 100% calc(100% - 24px), calc(100% - 24px) 100%, 24px 100%, 0 calc(100% - 24px), 0 calc(50% + 8px), 8px 50%, 0 calc(50% - 8px), 0 25px);
        z-index: -1;
    }
    ...
    .battles-spinner::after {
        ...
        left: 1px;
        background: #041f36;
        clip-path: polygon(24px 0, calc(100% - 24px) 0, 100% 24px, 100% calc(50% - 8px), calc(100% - 8px) 50%, 100% calc(50% + 8px), 100% calc(100% - 24px), calc(100% - 24px) 100%, 24px 100%, 0 calc(100% - 23px), 0 calc(50% + 8px), 8px 50%, 0 calc(50% - 8px), 0 24px);
        z-index: -1;
    }
    ...
    .battles-spinner .info-inner {
        ...
        clip-path: polygon(10px 0, calc(100% - 10px) 0, 100% 10px, 100% calc(50% - 6px), calc(100% - 5px) 50%, 100% calc(50% + 6px), 100% calc(100% - 10px), calc(100% - 11px) 100%, 10px 100%, 0 calc(100% - 10px), 0 calc(50% + 6px), 5px 50%, 0 calc(50% - 6px), 0 10px);
    }
