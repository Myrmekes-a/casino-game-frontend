    ...
    export default {
        ...
        computed: {
            ...
            battlesGetLink() {
                ...
                if(this.battlesGameData.game !== null) { link = 'demo.grakairos.com/battles/' + this.battlesGameData.game._id; }
...
<style scoped>
    .battles-header-game {
        width: 100%;
        display: grid;
        grid-template-columns: 111px auto 432px auto;
        align-items: center;
        padding-bottom: 35px;
    }
    ...
    .battles-header-game a.link-back:active {
    ...
    .battles-header-game button.button-fair:hover {
        transition-duration: .2s; 
        opacity: .8;
    }
    .battles-header-game button.button-fair:active {
        transition-duration: .2s;
        scale: .9;
    }
