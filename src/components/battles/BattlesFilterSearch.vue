...
<style scoped>
    ...
    .battles-filter-search:before {
        ...
        left: 0;
        background: #0a273f;
        clip-path: polygon(7px 0, calc(100% - 9px) 0, 100% 25%, 100% 75%, calc(100% - 8px) 100%, 9px 100%, 0 75%, 0 25%);
        z-index: -1;
    }
    ...
    .battles-filter-search input {
        ...
        clip-path: polygon(10px 0, calc(100% - 7px) 0, 100% 25%, 100% 75%, calc(100% - 9px) 100%, 9px 100%, 0 75%, 0 25%);
    }
